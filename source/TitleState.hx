...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		backupMan= new FlxSprite(0, FlxG.height * 0.55).loadGraphic(Paths.image('Scientist_Rysik5318','clown'));
		backupMan.visible = false;
		backupMan.setGraphicSize(Std.int(backupMan.width * 1.1));
		backupMan.updateHitbox();
		backupMan.screenCenter(X);
		backupMan.y -= 100;
		backupMan.antialiasing = true;
	...
	override function beatHit()
	{
		...
		switch (curBeat)
		{
			...
			case 15:
				backupMen.visible = false;
				deleteCoolText();
				createCoolText(['OPTIMIZATION'], 135);
			case 16:
				addMoreText('AND', 135);
			case 17:
				addMoreText('PROGRAMMING', 135);
			case 18:
				addMoreText('RYSIK5318', 135);
				backupMan.visible = true;
			case 19:
				deleteCoolText();
